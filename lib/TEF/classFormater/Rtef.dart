...
class RetornoMsiTef {
  ...
  late  String _cODRESP;
  late  String _cOMPDADOSCONF;
  late String _cODTRANS;
  late String _vLTROCO;
  late  String _rEDEAUT;
  late String _bANDEIRA;
  late String _nSUSITEF;
  late String _nSUHOST;
  late String _cODAUTORIZACAO;
  late String _tipoPARC;
  late String _numPARC;
  late String _viaESTABELECIMENTO;
  late String _viaCLIENTE;
