...
public class GertecPrinter {
     ...
     */
    public GertecPrinter(Context c, Context applicationContext) {
        this.context = c;
        startIGEDI();
    }
     ...
     * 
     * @param config = Classe {@link torres.com.sammi_go.ConfigPrint} que contém toda a configuração
     *               para a impressão
     */
     ...
     *          chamado a classe {@link torres.com.sammi_go.ConfigPrint} não será alterada para
    ...
    public boolean imprimeCupom(byte[] imagem) throws GediException {
        ...
        try {
            ...
            bmp = BitmapFactory.decodeByteArray(imagem,0,imagem.length, options);
   ...
   /* public boolean imprimeImagemRaw(Bitmap bmp) throws GediException {
